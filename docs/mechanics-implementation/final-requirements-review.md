...
**Remaining acceptance:** physical finger occlusion of warning/escape paths (A13) and a five-minute physical iPhone Safari boss/hazard run (A15). The latest iPhone Mirroring Connect attempt timed out due to phone use and requests locking the phone before reconnecting; no readiness reply or physical gameplay evidence has been received. See [device readiness](device-readiness.json). Publication was not part of this implementation goal and has not occurred.
