...
Fourteen recovered Higgsfield meshes now supply the matching characters, including the textured ogre and goblin. All sixteen characters use weighted 3D meshes and twelve gameplay clips; the recovered spider has its own eight-legged rig. Original artwork, meshes and historical interpretations remain archived. The September 17 Bone Throne is a streamed relic in the Hollow Throne chamber. [Recovered asset release](docs/RECOVERED_ASSET_RELEASE.md) records source identities, rigging, equipment, validation and limitations.
