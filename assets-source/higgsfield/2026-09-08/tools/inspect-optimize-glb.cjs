...
const LOCAL_CACHE = '/Users/nathaniel/.cache/ashen-september-deps';
const DEFAULT_DEPS = require('node:fs').existsSync(path.join(LOCAL_CACHE, 'node_modules/@gltf-transform/core/package.json'))
  ? LOCAL_CACHE : '/Users/nathaniel/Documents/ChatGPT/Knight/game';
