...
export class RosterAssets{
 ...
 private async refresh(){
  ...
  try{
   ...
   const obsolete=()=>this.stopped||tier!==this.tier||e.id!==id||e.distance>52||!e.actor.group.visible;
   ...
   const old=e.loaded,template={scene:incoming.scene,animations:incoming.animations};installRosterVisual(e.actor,template,model);e.loaded={gltf:template,tier};incoming=undefined;
