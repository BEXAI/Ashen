...
function fixture(phase,{openFloor=false,blockersDead=false}={}){
 ...
 Object.assign(g.p,{x:18.4+offset.x,z:-57.1+offset.z,shrines:['cinder','dusk','crown']});
 ...
 // the .45-radius hero. The rendered throne-room east/north walls close the other exits.
 // The previous south-corner fixture intersected the .9-deep end-wall masonry.
 add('w6',17.15,-57.2);add('w7',18.3,-58.35);const boss=add('king',13,-61.5);
